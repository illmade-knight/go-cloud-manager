...
// This test simulates the pre-flight check for the subscriber service.
...
`
	...
	require.NotEmpty(t, cfg.VerifyTopicID, "VerifyTopicID should be loaded from the YAML file")
	require.NotEmpty(t, cfg.SubscriptionID, "SubscriptionID should be loaded from the YAML file")
